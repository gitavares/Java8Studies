...
public class Datasource {
    ...
    public static final String CONNECTION_STRING = "jdbc:sqlite:/home/giselletavares/Documents/giselletavares/_CursosOnline/Udemy-CompleteJavaMasterClass/Java8Studies/Music/" + DB_NAME;
    ...
    public boolean updateArtistName(int id, String newName){
        try {
            ...
            int affectRecords = updateArtistName.executeUpdate();
    ...
    public void insertSong(String title, String artist, String album, int track) {
        ...
        try {
            ...
            try{
                ...
                System.out.println("Oh boy!" + e.getMessage());
            }
        } finally {
            try {
